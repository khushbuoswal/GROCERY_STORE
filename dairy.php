...
<body style="background-color: rgb(243, 243, 228);">
  ...
  <div class="container mt-5 product-container">
    <div class="row">
      ...
      $store = $connect->prepare("SELECT * FROM products WHERE product_category = 'Fresh' AND product_sub_category = 'Dairy Products' ");
      $store->execute();
      $dairy = $store->get_result();

      while ($row = $dairy->fetch_assoc()) {
      ...
      ?>
        ...
        <div class="col-md-4 mb-3">
          <div class="card">
            <img src="assets/images/<?php echo $row['product_image']; ?>" class="card-img-top" class="card-img-top" alt="Milk">
