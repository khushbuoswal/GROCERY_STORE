     ...
     <div class="containermt-5 product-container">
        <div class="row">
            <div class="col-md-6 mb-4">
                <div class="card-2">
                    <img src="assets/images/cleaningimg.jpeg" class="card-img-top" alt="Cleaning">
                    <div class="card-body-2 d-flex flex-column justify-content-center align-items-center mt-3">
                      <button class="btn btn-outline-success" onclick="window.location.href = 'cleaning.php';">Cleaning</button>
                    </div>
                </div>
            </div>
            <div class="col-md-6 mb-4">
                <div class="card-2">
                    <img src="assets/images/cookingtools.jpeg" class="card-img-top" alt="Cooking Tools">
                    <div class="card-body-2 d-flex flex-column justify-content-center align-items-center mt-3">
                      <button class="btn btn-outline-success" onclick="window.location.href = 'cooking.php';">Cooking Tools</button>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 mb-4">
                <div class="card-2">
                    <img src="assets/images/plants.jpeg" class="card-img-top" alt="Plants">
                    <div class="card-body-2 d-flex flex-column justify-content-center align-items-center mt-3">
                      <button class="btn btn-outline-success" onclick="window.location.href = 'plants.php';">Plants</button>
                    </div>
                </div>
            </div>
        </div>
