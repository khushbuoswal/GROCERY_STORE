     ...
     <div class="containermt-5 product-container">
        <div class="row">
            <div class="col-md-6 mb-4">
                <div class="card-2">
                    <img src="assets/images/canned.jpeg" class="card-img-top" alt="Canned">
                    <div class="card-body-2 d-flex flex-column justify-content-center align-items-center mt-3">
                        <button class="btn btn-outline-success" onclick="window.location.href = 'canned.php';">Canned</button>
                    </div>
                </div>
            </div>
            <div class="col-md-6 mb-4">
                <div class="card-2">
                    <img src="assets/images/Dry.jpeg" class="card-img-top" alt="Dry">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center mt-3">
                        <button class="btn btn-outline-success" onclick="window.location.href = 'dry.php';">Dry</button>
                    </div>
                </div>
            </div>
        </div>
