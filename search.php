...
if (isset($_GET['query'])) {
    ...
    $stmt = $connect->prepare("SELECT * FROM products WHERE product_name LIKE ? OR product_description LIKE ? OR product_category LIKE ?");
        ...
        <section id="category">
            <div class="container">
                <div class="row">
                    ...
                    $store = $connect->prepare("SELECT * FROM products");
                    $store->execute();
                    ...
                    ?>
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="card">
                                    <img src="assets/images/<?php echo $row['product_image']; ?>" class="card-img-top" alt="Highproteinbar">
