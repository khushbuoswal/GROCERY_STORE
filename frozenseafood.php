...
<div class="container mt-5 product-container">
    ...
    <?php
        ...
        $store = $connect->prepare("SELECT * FROM products WHERE product_category = 'Frozen' AND product_sub_category = 'Frozen Non-Plantable' ");
        $store->execute();
        $nonplantable = $store->get_result();

        while ($row = $nonplantable->fetch_assoc()) {
      ...
      ?>
        ...
        <div class="col-md-4 mb-3">
            <div class="card">
                <img src="assets/images/<?php echo $row['product_image'];?>" class="card-img-top" alt="Frozen Meat">
