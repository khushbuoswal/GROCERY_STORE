...
<body style="background-color: rgb(243, 243, 228);">
  ...
  <div class="container mt-5 product-container">
    <div class="row">
      ...
      $store = $connect->prepare("SELECT * FROM products WHERE product_category = 'Household Goods' AND product_sub_category = 'Cleaning' ");
      $store->execute();
      $cleaning = $store->get_result();

      while ($row = $cleaning->fetch_assoc()) {
      ...
      ?>
        <div class="col-md-4 mb-3">
          <div class="card">
            <img src="assets/images/<?php echo $row['product_image']; ?>" class="card-img-top" alt="Cleaning Spray">
