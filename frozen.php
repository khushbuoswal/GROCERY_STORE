     ...
     <div class="containermt-5 product-container">
        <div class="row">
            <div class="col-md-6 mb-4">
                <div class="card-2">
                    <img src="assets/images/frozenplantable.jpeg" class="card-img-top" alt="Frozen Plantable">
                    <div class="card-body-2 d-flex flex-column justify-content-center align-items-center mt-3">
                      <button class="btn btn-outline-success" onclick="window.location.href = 'plantable.php';">Frozen Plantable</button>
                    </div>
                </div>
            </div>
            <div class="col-md-6 mb-4">
                <div class="card-2">
                    <img src="assets/images/frozenseafood.jpeg" class="card-img-top" alt="Frozen Seafood">
                    <div class="card-body-2 d-flex flex-column justify-content-center align-items-center mt-3">
                      <button class="btn btn-outline-success" onclick="window.location.href = 'frozenseafood.php';">Frozen Non-Plantable</button>
                    </div>
                </div>
            </div>
        </div>
